...
from eulerinstall.tui.curses_menu import SelectMenu, Tui
from eulerinstall.tui.menu_item import MenuItem, MenuItemGroup
from eulerinstall.tui.result import ResultType
from eulerinstall.tui.types import Chars, FrameProperties, FrameStyle, PreviewStyle
...
class AbstractMenu(Generic[ValueT]):
	def __init__(
		self,
...
class AbstractSubMenu(AbstractMenu[ValueT]):
	def __init__(
		self,
		item_group: MenuItemGroup,
		config: Any,
